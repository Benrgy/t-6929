...
const HeroSection: React.FC<HeroSectionProps> = ({ searchQuery, onSearchChange }) => {
  ...
  return (
    <>
      {/* Hero Section */}
      <div className="relative h-[70vh] bg-gradient-to-r from-green-600 to-orange-600 overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-3xl">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90 leading-relaxed">
              {language === 'nl' 
                ? 'Ontdek de echte Algarve – zonder toeristische prijzen. Wij helpen je reis te plannen zoals een local!'
                : 'Discover the real Algarve – without tourist prices. We help you plan like a local!'
              }
            </p>
            ...
            <div className="max-w-lg mb-6">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder={language === 'nl' ? 'Zoek naar plekken, tips, of stel een vraag...' : 'Search for places, tips, or ask a question...'}
                  value={searchQuery}
            ...
            <div className="flex flex-wrap gap-4">
              ...
              >
                {language === 'nl' ? 'Bereken je Budget' : 'Calculate Budget'}
              </Button>
              <Button 
                size="lg"
                variant="outline"
      ...
      <div id="budget-calculator" className="py-16 bg-gradient-to-br from-green-50 to-orange-50">
